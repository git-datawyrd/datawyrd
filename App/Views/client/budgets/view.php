                ...
                <div class="sticky-top" style="top: 100px;">
                    ...
                    <?php elseif ($budget['status'] == 'approved' || $budget['status'] == 'invoiced'): ?>
                        <div
                            ...
                            <p class="text-success small mb-4">¡Excelente! Ya puedes proceder con el pago para activar tu
                                servicio.</p>
                            ...
                            <?php else: ?>
                                <p class="text-white-50 x-small italic">Nuestro equipo está terminando de procesar tu factura.
                                </p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
