        ...
        <div class="glass-morphism p-4 rounded-5 border-white-10 mb-4">
            ...
            <h2 class="text-white h5 fw-black mb-1">
                ...
                <div class="space-y-4">
                    <div class="mb-3">
                        <label
                            class="text-white-50 x-small uppercase fw-bold tracking-widest d-block mb-1">Cliente</label>
                ...
                <?php if (!\Core\Auth::isClient()): ?>
                    ...
                    <div class="mb-4">
                        <label
                            class="text-white-50 x-small uppercase fw-bold tracking-widest d-block mb-2">Presupuesto</label>
                        <?php if ($budget): ?>
                    ...
                    <?php if ($budget): ?>
                        ...
                        <div class="mb-4">
                            ...
                            <a href="/datawyrd/budget/show/<?php echo $budget['id']; ?>"
                                ...
                                <span class="material-symbols-outlined fs-6 align-middle me-1">visibility</span> Revisar
                                Propuesta
                            </a>
                        </div>
                    <?php endif; ?>
        ...
        <div class="glass-morphism rounded-5 border-white-10 overflow-hidden d-flex flex-column"
            ...
            <div
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h2 class="text-white h6 mb-0 fw-black">Comunicación Directa</h2>
                </div>
